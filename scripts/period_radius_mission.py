...
from bokeh.models import CustomJS, FuncTickFormatter, OpenURL, TapTool
...
# output CSV files
csvhead = '# Planet Name, Period (days), Radius (Earths), ' \
          'Radius (Jupiters), Discovered by'
keys = ['planet', 'period', 'radius', 'jupradius', 'discovery']
