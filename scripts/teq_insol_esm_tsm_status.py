...
for fn, ifig in enumerate(np.arange(len(refwavs))):
    for imet in ['esm', 'tsm']:
        ...
        for ixx in np.arange(2):
            ...
            # output files
            embedfile = f'_includes/{istr}_{ikey}_status_candidates_embed.html'
            fullfile = f'_includes/{istr}_{ikey}_status_candidates.html'
            ...
            for ii in np.arange(2):
                ...
                if ii == 1:
                    legend.title = 'Planets and Candidates with ' \
                                   'R < 2 Earth Radii'
                    legend.spacing = 10
                else:
                    legend.spacing = 11
            ...
            # save the individual piecesm, so we can just embed the figure
